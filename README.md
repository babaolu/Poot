...
| **Miner Daemon (1B)** | Background Daemon & UI | React Native / Java | *In Progress* | UI shell created. Native background scheduling (WorkManager/Thermal APIs) pending. |
...
| **Orchestrator (1C)** | Persistence Store | C++23 / PostgreSQL | *In Progress* | Postgres schema & C++ RAII PGconn wrapper implemented. Falling back to memory due to libpq syntax errors. |
